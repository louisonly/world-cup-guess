...
public class BetService {
    ...
    //根据userIp,matchId更新bet表中竞猜结果
    public List<Bet> getResult(Bet bet){
    	//List<Integer> matchIds;
    	betMapper.updateInfoByIp(bet);
    	List<Bet> bets = betMapper.findByIp(bet);
    	return bets;
    }
    public int getCounts(Bet bet) {
    	return betMapper.countBets(bet);
    }
